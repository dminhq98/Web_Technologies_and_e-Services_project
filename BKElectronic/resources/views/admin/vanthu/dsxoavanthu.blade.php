...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            @endif
            <?php
                $vanthu=\App\VanThu::where('trang_thai',0)->get();
            $i=1;
            ?>
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="position: relative;">
                    ...
                    {{--</ul>--}}
                    {{--</div>--}}
                    <a href="admin/vanthu/danhsachvanthu" class="btn btn-primary" style="margin: 10px 0 20px 0; position: absolute;">Danh sách văn thư</a>
