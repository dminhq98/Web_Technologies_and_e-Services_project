                ...
                @foreach($thubao as $tb)
                    <tr>
                        <td data-id="showdetail" data-sendmsgrequestid="SR2019041310040">
                            ...
                            <div><a href="giaovien/thubao/{{$tb['id']}}" style="cursor: pointer;float: right;font-size: 12px;font-weight: bold;" data-id="showdetail " data-sendmsgrequestid="SR2019041310040">›› Xem chi tiết</a></div>
                        </td>
                    </tr>
                @endforeach
                </tbody>
